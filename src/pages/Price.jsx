    ...
    return (
        <main
                ...
                <div className="px-6 sm:px-8 md:px-10 pt-14 sm:pt-0">
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <div>
                            ...
                            {isAD1ModalOpen && (
                                <div
                                    className="fixed z-10 inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center"
                                    onClick={toggleAD1Modal}
                                >
                                    <div
                                        className="bg-white p-8 rounded-lg max-w-lg w-full"
            ...
            <div className="relative z-0 mt-10">
                ...
                <div className="w-full h-[1200px] md:h-[60vh] lg:h-[50vh] relative">
                    <div
                        ...
                        <div
                            className="p-2 md:p-4 h-full bg-gradient-to-br from-sky-800 via-blue-950 to-gray-800 col-span-2">
                            <form>
                                <div
