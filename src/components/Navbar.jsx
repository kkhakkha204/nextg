...
const Navbar = () => {
    ...
    return (
        <nav
            className={`z-50 border-b-4 border-sky-300 bg-custom-gradient font-[Oswald] shadow-2xl shadow-sky-600 fixed w-full top-0 left-0 transition-all duration-300 opacity-95 ${
