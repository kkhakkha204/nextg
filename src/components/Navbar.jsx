...
const Navbar = () => {
    ...
    return (
        <nav
            className={`bg-custom-gradient-logo font-[Oswald] shadow-2xl shadow-[#172554] fixed w-full top-0 left-0 z-10 transition-all duration-300 ${
            ...
            <div className="container mx-auto px-4 flex flex-wrap items-center justify-between h-16">
                ...
                <div className="flex items-center space-x-2 xl:ml-5">
                    <Link to="/" className="h-[4rem] w-[12.5rem]">
                        <img
                            src="/assets/images/logos/logoNG.png"
                            alt="Nextg Logo"
